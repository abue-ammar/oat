...
description = "Useful zero-dependecy libs"
+++
...
- [**indexed-cache.js**](https://github.com/knadh/indexed-cache): A tiny Javsacript library for sideloading static assets on pages and caching them in the browser's IndexedDB for longer-term storage. ~2.1 KB
